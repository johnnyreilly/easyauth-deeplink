...
Please do [report an issue on the issue tracker](https://github.com/johnnyreilly/easyauth-deeplink/issues/new/choose) if there's any bugfix, documentation improvement, or general enhancement you'd like to see in the repository!
...
With the exception of very small typos, all changes to this repository generally need to correspond to an [open issue marked as `accepting prs` on the issue tracker](https://github.com/johnnyreilly/easyauth-deeplink/issues?q=is%3Aopen+is%3Aissue+label%3A%22accepting+prs%22).
If this is your first time contributing, consider searching for [issues that also have the `good first issue` label](https://github.com/johnnyreilly/easyauth-deeplink/issues?q=is%3Aopen+is%3Aissue+label%3A%22accepting+prs%22+label%3A%22good+first+issue%22).
...
Check [previously merged PRs](https://github.com/johnnyreilly/easyauth-deeplink/pulls?q=is%3Apr+is%3Amerged+-label%3Adependencies+) for reference.
